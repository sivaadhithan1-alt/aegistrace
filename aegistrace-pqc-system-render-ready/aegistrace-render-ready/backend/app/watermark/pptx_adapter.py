"""
PPTX (Microsoft PowerPoint) Forensic Watermarking Adapter.
Multi-layer invisible embedding using OOXML custom properties and hidden slide note metadata.
"""
...
class PptxWatermarkAdapter(BaseWatermarkAdapter):
    @property
    def adapter_name(self) -> str:
        return "PPTX-CustomProps-Adapter-v1"
